...
class MusicWidgetReceiver : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_PLAY_PAUSE = "com.nestmusic.music.widget.PLAY_PAUSE"
        const val ACTION_LIKE = "com.nestmusic.music.widget.LIKE"
        const val ACTION_NEXT = "com.nestmusic.music.widget.NEXT"
        const val ACTION_PREVIOUS = "com.nestmusic.music.widget.PREVIOUS"
        const val ACTION_UPDATE_WIDGET = "com.nestmusic.music.widget.UPDATE_WIDGET"
    }
}
