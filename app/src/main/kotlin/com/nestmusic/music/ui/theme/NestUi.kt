...
/** Classic (pre-2026) default seed color, kept so the old UI stays identical. */
val LegacyThemeColor = Color(0xFFED5564)

/**
 * Classic (pre-2026) type scale: standard M3 weights, used when the user
 * picks the classic interface.
 */
...
fun useNestUi(): Boolean {
    val (nestUi) = rememberPreference(NestUiKey, defaultValue = true)
    return nestUi
}
