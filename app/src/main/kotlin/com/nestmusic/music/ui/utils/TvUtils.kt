 ...
 * 
 * @Suppress("Deprecation") - IndicationInstance is deprecated in newer Compose versions,
 * but this class provides the required API for LocalIndication compatibility.
 */
...
class TvFocusIndication(
    ...
    override fun rememberUpdatedInstance(interactionSource: androidx.compose.foundation.interaction.InteractionSource): androidx.compose.foundation.IndicationInstance {
        ...
        return object : androidx.compose.foundation.IndicationInstance {
            override fun dispose() {
                // Clean up state on disposal
            }
