...
package com.nestmusic.music.ui.screens.library
...
import com.nestmusic.music.constants.CONTENT_TYPE_PLAYLIST
...
import com.nestmusic.music.constants.MixSortDescendingKey
import com.nestmusic.music.constants.MixSortType
import com.nestmusic.music.constants.MixSortTypeKey
import com.nestmusic.music.constants.ShowCachedPlaylistKey
import com.nestmusic.music.constants.ShowDownloadedPlaylistKey
import com.nestmusic.music.constants.ShowLikedPlaylistKey
import com.nestmusic.music.constants.ShowTopPlaylistKey
import com.nestmusic.music.constants.ShowUploadedPlaylistKey
...
import com.nestmusic.music.viewmodels.LibraryMixViewModel
                ...
                LazyVerticalGrid(
                    ...
                    if (searchQuery.isBlank()) {
                        item(
                            ...
                            AiPlaylistEntryCard(onClick = { navController.navigate("ai_playlist") })
                        }
                    }
...
@Composable
private fun AiPlaylistEntryCard(onClick: () -> Unit) {
    Card(
        modifier =
            Modifier
                .fillMaxWidth()
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                Text(
                    text = stringResource(R.string.ai_playlist_entry_desc),
